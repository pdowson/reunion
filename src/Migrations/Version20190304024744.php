 ...
 */
final class Version20190304024744 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Added ManyToOne relationship between Contact and ClassmateYear';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__contact AS SELECT id, classmate_id, created_date, updated_date, created_by, updated_by, delete_date_time, current_name, significant_other, address_1, address_2, city, state, zip, phone, info_string, email FROM contact');
        $this->addSql('DROP TABLE contact');
        $this->addSql('CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, classmate_id INTEGER NOT NULL, classmate_year_id INTEGER NOT NULL, created_date DATETIME NOT NULL, updated_date DATETIME NOT NULL, created_by VARCHAR(255) NOT NULL COLLATE BINARY, updated_by VARCHAR(255) NOT NULL COLLATE BINARY, delete_date_time DATETIME DEFAULT NULL, current_name VARCHAR(100) DEFAULT NULL COLLATE BINARY, significant_other VARCHAR(100) DEFAULT NULL COLLATE BINARY, address_1 VARCHAR(100) DEFAULT NULL COLLATE BINARY, address_2 VARCHAR(255) DEFAULT NULL COLLATE BINARY, city VARCHAR(255) DEFAULT NULL COLLATE BINARY, state VARCHAR(255) DEFAULT NULL COLLATE BINARY, zip VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone VARCHAR(255) DEFAULT NULL COLLATE BINARY, info_string CLOB DEFAULT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_4C62E6381B60D683 FOREIGN KEY (classmate_id) REFERENCES classmate (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4C62E638825CBE03 FOREIGN KEY (classmate_year_id) REFERENCES classmate_year (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO contact (id, classmate_id, created_date, updated_date, created_by, updated_by, delete_date_time, current_name, significant_other, address_1, address_2, city, state, zip, phone, info_string, email) SELECT id, classmate_id, created_date, updated_date, created_by, updated_by, delete_date_time, current_name, significant_other, address_1, address_2, city, state, zip, phone, info_string, email FROM __temp__contact');
